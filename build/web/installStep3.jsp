        ...
        <div class="container"> <!-- container -->
            ...
            <div class="row">
                <div class="span11">
                    ...
                    <br>                    
                    <%
                        cmd = request.getParameter("glassfishHome") + "asadmin create-jdbc-resource --user admin --connectionpoolid connection_pool_ssn_3_1 jdbc/ssn_3_1";
                        //out.println(new CMD(response.getWriter()).exec(cmd));
                    %> 
                    <br/>
                    <br/>
                    ...
                    <br>                    
                    <%
                        cmd = request.getParameter("glassfishHome") + "asadmin create-jms-resource --restype=javax.jms.TopicConnectionFactory jms_connection_factory_ssn_3_1";
                        //out.println(new CMD(response.getWriter()).exec(cmd));
                    %>
                    <br/>
                    <br/>
                    ...
                    <br>                    
                    <%
                        cmd = request.getParameter("glassfishHome") + "asadmin create-jms-resource --restype=javax.jms.Topic jms_topic_ssn_3_1";
                        //out.println(new CMD(response.getWriter()).exec(cmd));
                    %>
                    <div class="textRed">
                        <%=cmd%>
